...
<div class="flex flex-col gap-4">
	<div class="flex justify-between">
		<div>
			...
			<p class="text-muted-foreground text-sm">Manage your discord bot.</p>
		</div>
		<div>
			<Button
				on:click={async () => {
	...
	<div class="flex flex-col gap-4">
		...
		<div class="flex flex-col gap-2">
			...
			<p class="text-muted-foreground text-sm">Select the text support channel</p>
		...
		<div class="flex flex-col gap-2">
			...
			<p class="text-muted-foreground text-sm">Select the role to assign linked users to</p>
			<Selector
				options={data.roles}
